var messages = {
  ...
  title: {
    'en': 'IT RUN Grid Garden - A game for learning CSS grid',
    'hi': 'IT RUN Grid Garden - CSS grid सीखने के लिए एक खेल',
    'ro': 'IT RUN Grid Garden - Un joc pentru a învăța CSS grid',
    'sr': 'IT RUN Grid Garden - Игра за учење CSS grid-а',
    'bg': 'IT RUN Grid Garden - Игра за учене на CSS grid',
    'de': 'IT RUN Grid Garden - Ein Spiel, um CSS Grid zu lernen',
    'fr': 'IT RUN Grid Garden - Un jeu pour apprendre les grid CSS',
    'pt-br': 'IT RUN Grid Garden - Um jogo para aprender CSS grid',
    'es': 'IT RUN Grid Garden - Un juego para aprender CSS grid',
    'ru': 'IT RUN Grid Garden - Игра для изучения CSS Grid',
    'fa': 'باغ گرید - یک بازی جذاب برای آموزش سی اس اس گرید',
    'zh-cn': 'IT RUN Grid Garden - 一个用来学CSS grid的游戏',
    'zh-tw': 'IT RUN Grid Garden - 一個用來學CSS grid的遊戲',
